...
CREATE TABLE `estado_multa` (
  `pk_est_multa` int(11) NOT NULL AUTO_INCREMENT,
  `mult_dsc` varchar(45) NOT NULL,
  PRIMARY KEY (`pk_est_multa`)
...
INSERT INTO `estado_multa` VALUES (1,'Pagado'),(2,'Pendiente'),(3,'Condonado');
