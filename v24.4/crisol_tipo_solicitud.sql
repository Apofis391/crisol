...
CREATE TABLE `tipo_solicitud` (
  `pk_tp_soli_id` tinyint(4) NOT NULL AUTO_INCREMENT,
  `tp_soli_dsc` varchar(45) NOT NULL,
  PRIMARY KEY (`pk_tp_soli_id`)
...
INSERT INTO `tipo_solicitud` VALUES (1,'Préstamo Ordinario'),(2,'Préstamo Refinanciado'),(3,'Préstamo Emergente');
