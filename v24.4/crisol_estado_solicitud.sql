...
CREATE TABLE `estado_solicitud` (
  `pk_est_soli_id` smallint(6) NOT NULL AUTO_INCREMENT,
  `est_soli_dsc` varchar(45) NOT NULL,
  PRIMARY KEY (`pk_est_soli_id`)
...
INSERT INTO `estado_solicitud` VALUES (1,'Ingresado'),(2,'Aprobado'),(3,'Rechazado');
