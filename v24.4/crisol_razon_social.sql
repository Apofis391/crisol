...
CREATE TABLE `razon_social` (
  `pk_rzn_id` tinyint(4) NOT NULL AUTO_INCREMENT,
  `rzn_dsc` varchar(45) NOT NULL,
  PRIMARY KEY (`pk_rzn_id`)
...
INSERT INTO `razon_social` VALUES (1,'Natural');
...
-- Dump completed on 2024-03-22 22:13:30
