...
CREATE TABLE `cierre_diario` (
  `pk_cir_id` int(11) NOT NULL AUTO_INCREMENT,
  `cir_tot_ingre` decimal(10,2) NOT NULL,
  `cir_tot_egre` decimal(10,2) NOT NULL,
  `cir_saldo` decimal(10,2) NOT NULL,
  `cir_fecha` date NOT NULL,
  PRIMARY KEY (`pk_cir_id`)
...
INSERT INTO `cierre_diario` VALUES (1,0.00,0.00,0.00,'2024-02-05'),(3,2553.48,0.00,2553.48,'2024-02-13');
