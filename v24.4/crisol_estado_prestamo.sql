...
CREATE TABLE `estado_prestamo` (
  `pk_est_pres` tinyint(4) NOT NULL AUTO_INCREMENT,
  `est_pres_dsc` varchar(45) NOT NULL,
  PRIMARY KEY (`pk_est_pres`)
...
INSERT INTO `estado_prestamo` VALUES (1,'Activo'),(2,'Pagando'),(3,'Terminado'),(4,'Refinanciado'),(5,'Ingresado');
