...
CREATE TABLE `estado_cargo` (
  `pk_est_crg_id` tinyint(4) NOT NULL AUTO_INCREMENT,
  `est_crg_dsc` varchar(45) NOT NULL,
  PRIMARY KEY (`pk_est_crg_id`)
...
INSERT INTO `estado_cargo` VALUES (1,'Activado'),(2,'Desactivado');
